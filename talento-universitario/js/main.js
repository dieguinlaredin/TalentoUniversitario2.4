/**
 * Talento Universitario - Página única: carga aside y módulos en #content-block
 * Datos de formularios solo en memoria (no se persisten); con backend se guardará en BD.
 */
...
(function () {
  ...
  var MODULES = {
    institucional: 'partials/modulo-institucional.html',
  ...
  window.loadModule = function (moduleName) {
    ...
    loadPartial(url, contentBlock, function () {
      ...
      if (moduleName === 'institucional' && typeof window.initModuloInstitucional === 'function') {
        window.initModuloInstitucional();
      }
